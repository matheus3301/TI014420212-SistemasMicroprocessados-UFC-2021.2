...
#define SHT11_PORT 				GPIOA
#define SHT11_DATA_PIN 			GPIO_PIN_1
#define SHT11_SCK_PIN 			GPIO_PIN_2

#define SHT11_DATA_IO 			SHT11_PORT, SHT11_DATA_PIN
#define SHT11_SCK_IO 			SHT11_PORT, SHT11_SCK_PIN

#define SHT11_SET_DATA_HIGH() 	{HAL_GPIO_WritePin	(SHT11_PORT, SHT11_DATA_PIN, GPIO_PIN_SET);}
#define SHT11_SET_DATA_LOW()	{HAL_GPIO_WritePin	(SHT11_PORT, SHT11_DATA_PIN, GPIO_PIN_RESET);}
#define SHT11_SET_SCK_HIGH() 	{HAL_GPIO_WritePin	(SHT11_PORT,SHT11_SCK_PIN , GPIO_PIN_SET);}
#define SHT11_SET_SCK_LOW()	 	{HAL_GPIO_WritePin	(SHT11_PORT,SHT11_SCK_PIN , GPIO_PIN_RESET);}
